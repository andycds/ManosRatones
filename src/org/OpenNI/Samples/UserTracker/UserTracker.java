...
public class UserTracker extends Component {
    ...
    private final String SAMPLE_XML_FILE = "./cfg/SamplesConfig.xml";
    public UserTracker() {
...
//    	drawLine(g, dict, SkeletonJoint.LEFT_HAND, SkeletonJoint.RIGHT_HAND);
//    	g.setColor(color);
    ...
    public void paint(Graphics g) {
    	if (drawPixels) {
            ...
            ColorModel colorModel = new ComponentColorModel(
            		ColorSpace.getInstance(ColorSpace.CS_sRGB), new int[]{8, 8, 8}, false, false, ComponentColorModel.OPAQUE, DataBuffer.TYPE_BYTE);
